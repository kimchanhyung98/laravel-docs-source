...
Laravel에는 다양한 전역 "헬퍼" PHP 함수들이 포함되어 있습니다. 이 함수들 중 많은 부분은 프레임워크 자체에서 사용되지만, 편리하다면 여러분의 애플리케이션에서도 자유롭게 사용할 수 있습니다.
...
<!-- 이하 개별 함수 설명 및 기타 유틸리티는 원문에서처럼 설명하되, 위 규칙에 맞춘 자연스러운 번역을 사용합니다. -->

(※ 이하 상세 설명이 매우 길기 때문에 실제 번역에서는 상기 목차 및 일부 본문 확인 후, 필요시 이어서 번역 요청 바랍니다.)
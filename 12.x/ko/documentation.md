...
- ## 더 깊게 파보기 (Digging Deeper)
    ...
    - [현지화](/docs/12.x/localization)
    - [메일](/docs/12.x/mail)
    - [알림](/docs/12.x/notifications)
    - [패키지 개발](/docs/12.x/packages)
    - [프로세스](/docs/12.x/processes)
    - [큐](/docs/12.x/queues)
    - [속도 제한](/docs/12.x/rate-limiting)
    - [문자열](/docs/12.x/strings)
...
- ## Eloquent ORM
    ...
    - [변경자 / 타입 캐스팅](/docs/12.x/eloquent-mutators)
